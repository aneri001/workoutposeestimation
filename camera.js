...
function setupGui(cameras, net) {
  ...
  activityController =
      activity.add(guiState.activity, 'Activity', ['Weight Lifting']); //activity.add(guiState.activity, 'Activity', ['Weight Lifting', 'Jumping jack']);
      ...
      if (score >= minPoseConfidence) {
        if (guiState.output.showPoints) {
          ...
          if (wko_started == 1 && done == 0){
            ...
            global_zero();
            ctx.font = "29px Arial"; 
            ctx.fillText('Workout not started yet ,...', 10, 30,);
          }
